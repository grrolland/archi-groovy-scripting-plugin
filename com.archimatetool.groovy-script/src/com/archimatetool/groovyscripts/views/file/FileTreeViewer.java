...
public abstract class FileTreeViewer extends TreeViewer {
    ...
    protected class FileTreeLabelProvider extends CellLabelProvider {
        ...
        public Image getImage(File file) {
            ...
            if (file.getName().endsWith(".deps"))
            {
            	return IArchiScriptImages.ImageFactory.getImageDescriptor(IArchiScriptImages.ICON_DEPS).createImage();
            }
            if (file.getName().endsWith(".groovy"))
            {
            	return IArchiScriptImages.ImageFactory.getImageDescriptor(IArchiScriptImages.ICON_GROOVY).createImage();
            }
