 ...
 */
package com.archimatetool.groovyscripts.preferences;
...
implements IWorkbenchPreferencePage, IPreferenceConstants {
    ...
    public static final String ID = "com.archimatetool.groovyscript.preferences.ScriptPreferencePage";  //$NON-NLS-1$
    
    private static final String HELP_ID = "com.archimatetool.groovyscript.prefs"; //$NON-NLS-1$
